<template>
  <div class="Imbox">
    ...
    <div style="padding: 10px; margin-bottom: 50px;margin-top: 30px">
    <el-row>
      <el-col :span="15">
        <div style="width: 800px; margin: 0 auto; background-color: white;
          ...
          <div style="height: 200px; width: 750px;">
          ...
          <el-button class="imButton" type="primary" size="mini" @click="send">发送</el-button>
        </div>
        
      </el-col>
      <el-col :span="8">
        <el-card style="width: 100%; min-height: 300px; color: #333;box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.215);">
...
export default {
  ...
  data() {
    return {
      circleUrl: "https://browne.oss-cn-shenzhen.aliyuncs.com/Avatar.jpg",
      user: {},
      isCollapse: false,
      users: [],
      chatUser: "",
